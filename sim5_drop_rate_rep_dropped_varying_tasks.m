...
all_results = cell(1, length(0.1:ones_percentage_step_size:1));
ctr = 1;
for ones_percentage=0.1:ones_percentage_step_size:1
    %Workers history
...
ones_percentage = 0.1:ones_percentage_step_size:1;
for i=1:length(all_results)
    PBTA_plot = '';
    PBTA_MCMF_plot = '';
    PBTA_rep_dropped_plot = '';
