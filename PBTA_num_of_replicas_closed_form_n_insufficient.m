function [num_of_replicas_all_casses, actual_allocated_total_replicas_all_casses] = PBTA_num_of_replicas_closed_form_n_insufficient(n, m, tasks_priorities)
...
get_num_of_replicas_per_task = @(n, m, task_priority, lambda_1, lambda_2) ((1 ./ n) .* task_priority) + ((lambda_2 - lambda_1) ./ 2);
...
lambda_1 = 0;
lambda_2 = (-2 .* (1 ./ (m .* n))) .* sum(tasks_priorities);
...
%% Case 3: lambda_1 \neq 0, lambda_2 = 0
lambda_1 = (2 ./ m) .* (((1 ./ n) .* sum(tasks_priorities)) - n);
lambda_2 = 0;
