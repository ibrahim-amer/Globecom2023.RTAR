...
% Plot the surfaces
hold on;
surf(x1, y1, z1, 'FaceColor', 'green'); % Surface 1 with green color
surf(x2, y2, z2, 'FaceColor', 'blue'); % Surface 2 with blue color
surf(x3, y3, z3, 'FaceColor', 'red'); % Surface 3 with red color
...
dummy1 = plot(NaN, NaN, 's', 'MarkerFaceColor', 'green', 'MarkerEdgeColor', 'none');
dummy2 = plot(NaN, NaN, 's', 'MarkerFaceColor', 'blue', 'MarkerEdgeColor', 'none');
dummy3 = plot(NaN, NaN, 's', 'MarkerFaceColor', 'red', 'MarkerEdgeColor', 'none');
